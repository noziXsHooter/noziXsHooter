...
#define TOPICO_PUBLISH   "********"    //tópico MQTT de envio de informações para Broker
                                                   ...
                                                   //            de outra pessoa.
#define ID_MQTT  "Acionador"     //id mqtt (para identificação de sessão)
...
{   
    ...
    if(tempo>conttime)
    {
      Serial.println("Contagem Terminada");
      startmillis = 0;
      EstadoSaida == '0';
      conttime = 0;
    }
